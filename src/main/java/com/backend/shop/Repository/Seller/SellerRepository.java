...
public class SellerRepository {
    ...
    // ============================================================
    // RowMapper: map DB row → SellerModel
    // ============================================================
    private SellerModel mapRowToSeller(ResultSet rs, int rowNum) throws SQLException {
        ...
        // Email must exist in your sellers table
    ...
    // ============================================================
    // Insert new seller application (PENDING)
    // ============================================================
    public void save(SellerModel seller) {
        ...
        jdbcTemplate.update(sql,
                ...
                seller.getStatus() != null ? seller.getStatus().name() : SellerStatus.PENDING.name(),
                appliedAt,
                now,
                now
        );
    ...
    // ============================================================
    // Update seller basic profile (Seller can edit shop info)
    // ============================================================
    ...
    // ============================================================
    // Admin updates seller status (APPROVED / REJECTED)
    // ============================================================
    ...
    // ============================================================
    // Count pending applications (dashboard)
    // ============================================================
